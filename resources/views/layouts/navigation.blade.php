<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('aircraft.index')" :active="request()->routeIs('aircraft.*')">
                {{ __('aircraft') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('aircraft.index')" :active="request()->routeIs('events.*')">
                {{ __('Events') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Auth::check() ? Auth::user()->email : 'Login/Signup' }}</div>
            </div>
